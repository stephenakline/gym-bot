...
sqlite_file   = os.getcwd() + '/database/workouts.sqlite'
...
c.execute("ALTER TABLE {tn} ADD COLUMN '{cn}'".format(tn=table_run, cn="date_time", ft="TEXT"))
...
c.execute("ALTER TABLE {tn} ADD COLUMN '{cn}'".format(tn=table_workout, cn="date_time", ft="TEXT"))
